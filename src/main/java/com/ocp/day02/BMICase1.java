...
public class BMICase1 {
    public static void main(String[] args) {
        ...
        System.out.printf("姓名: %s 身高: %.f 體重: %.f BMI: %.2f  結果: %s",name1,height1,weight1,bmi1,result1);
        ...
        System.out.printf("姓名: %s 身高: %.f 體重: %.f BMI: %.2f  結果: %s", name2, height2, weight2, bmi2, result2);        
    }
}
